...
def metric_calculate(result_all, base_path, subfile_l,  select, txt_name,):
    ...
    for i in range(len(subfile_l)):
        subfile = subfile_l[i]
        # positive
        print(os.path.join(base_path, subfile + select, txt_name))
        ...
        print(result_auc_l[i], result_f1_l[i], result_acc_l[i], result_recall_l[i], result_precision_l[i])
...
# tgt_sparse_l = ['0.01', '0.05', '0.10', '0.20', '0.40']
save_path_l = ['']
save_path_l = []
for i in range(3):
    save_path_l.append('')
...
percentage_l=[0.005, 0.016, 0.017, 0.03, 0.04, 0.06, 0.14]
# percentage_l=[0.005, 0.016, 0.017, 0.04, 0.05, 0.06, 0.14]
# percentage_l=[0.005, 0.02, 0.06, 0.08, 0.1, 0.12, 0.14]
# percentage_l=[0.005, 0.016, 0.017, 0.03, 0.04]
n_l = []
