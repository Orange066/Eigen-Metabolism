            ...
            with open(save_name + '_' + tgt_sparse + '.sh', 'w') as file:
                for i in range(6):
                        ...
                        w_str = base_command_2 + '--x_test_path data_select/' + str(i).zfill(
                            ...
                            4) + '_' + save_path_l[save_name_id] +'_' + tgt_sparse_l[tgt_sparse_id] +' ' + ' --device ' + device_l[save_name_id*2+tgt_sparse_id]
                        file.write(w_str + '\n\n')
                        w_str = base_command_3 + '--x_train_path select_results/base_'+c1_save + str(i).zfill(
                            ...
                            4) + '_' + save_path_l[save_name_id] +'_' + tgt_sparse_l[tgt_sparse_id] + '_p' + ' --device ' + device_l[save_name_id*2+tgt_sparse_id]
                        file.write(w_str + '\n\n')
                        w_str = base_command_4 + '--x_test_path select_results/base_'+c1_save + str(i).zfill(
                            ...
                            4) + '_' + save_path_l[save_name_id] +'_' + tgt_sparse_l[tgt_sparse_id] + '_p/model-val-auc-best.pth' + ' --device ' + device_l[save_name_id*2+tgt_sparse_id]
                        file.write(w_str + '\n\n')
                        w_str = base_command_5 + '--x_train_path select_results/base_'+c1_save + str(i).zfill(
                            ...
                            4) + '_' + save_path_l[save_name_id] +'_' + tgt_sparse_l[tgt_sparse_id] + '_n' + ' --device ' + device_l[save_name_id*2+tgt_sparse_id]
                        file.write(w_str + '\n\n')
                        w_str = base_command_6 + '--x_test_path select_results/base_'+c1_save + str(i).zfill(
                            ...
                            4) + '_' + save_path_l[save_name_id] +'_' + tgt_sparse_l[tgt_sparse_id] + '_n/model-val-auc-best.pth' + ' --device ' + device_l[save_name_id*2+tgt_sparse_id]
                        file.write(w_str + '\n\n')
