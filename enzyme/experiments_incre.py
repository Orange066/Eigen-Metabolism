...
parser.add_argument("--excluded_idx", default=0, type=int)
parser.add_argument("--select_num", default=0, type=int)
parser.add_argument("--prop_idx", default=0, type=int)
parser.add_argument("--incre_all_idx", default=0, type=int)
parser.add_argument("--incre_single_idx", default='0000_0001', type=str)
...
incre_all_idx = args.incre_all_idx
incre_single_idx = args.incre_single_idx
...
elif run_type == 'random_select':
    positive_samples_name = positive_samples_name + '_random_select_' + str(select_num).zfill(4) + '_' + str(random_idx).zfill(4) + '.csv'
    negative_samples_name = negative_samples_name + '_random_select_' + str(select_num).zfill(4) + '_' + str(random_idx).zfill(4) + '.csv'
elif run_type == 'random_select_in':
    positive_samples_name = positive_samples_name + '_random_select_in_' + str(select_num).zfill(4) + '_' + str(random_idx).zfill(4) + '.csv'
    negative_samples_name = negative_samples_name + '_random_select_in_' + str(select_num).zfill(4) + '_' + str(random_idx).zfill(4) + '.csv'
elif run_type == 'incre_all':
    positive_samples_name = positive_samples_name + '_incre_all_' + str(incre_all_idx).zfill(4) + '.csv'
    negative_samples_name = negative_samples_name + '_incre_all_' + str(incre_all_idx).zfill(4) + '.csv'
elif run_type == 'incre_single':
    positive_samples_name = positive_samples_name + '_incre_single_' + incre_single_idx + '.csv'
    negative_samples_name = negative_samples_name + '_incre_single_' + incre_single_idx + '.csv'
elif run_type == 'excluded':
    positive_samples_name = positive_samples_name + '_excluded_' + str(excluded_idx).zfill(4) + '.csv'
    negative_samples_name = negative_samples_name + '_excluded_' + str(excluded_idx).zfill(4) + '.csv'


save_path = task + '_' + run_type
if run_type == 'random':
    save_path = save_path + '_' + str(select_num).zfill(4) + '_' + str(random_idx).zfill(4)
if run_type == 'prop':
    save_path = save_path + '_' + str(select_num).zfill(4) + '_' + str(prop_idx).zfill(4)
if run_type == 'random_select':
    save_path = save_path + '_' + str(select_num).zfill(4) + '_' + str(random_idx).zfill(4)
if run_type == 'random_select_in':
    save_path = save_path + '_' + str(select_num).zfill(4) + '_' + str(random_idx).zfill(4)
if run_type == 'incre_all':
    save_path = save_path + '_' + str(incre_all_idx)
if run_type == 'incre_single':
    save_path = save_path + '_' + str(excluded_idx).zfill(4)
if run_type == 'excluded':
    save_path = save_path + '_' + str(excluded_idx).zfill(4)
print('save_path', os.path.join(save_base, organ, save_path))
